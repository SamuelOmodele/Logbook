...
const SidebarDeptSup = () => {
    ...
    return (
        <nav className="sidebar">
          ...
          <div>
              <Link className='link' to='/dept-supervisor'><li className='sidebar-link active' id={(currentPath === '/dept-supervisor') ? 'active' : ''}><ion-icon name="home-outline"></ion-icon>Home</li></Link>
              <Link className='link' to='/dept-supervisor/student'><li className='sidebar-link' id={(currentPath === '/dept-supervisor/student') ? 'active' : ''}><ion-icon name="people-outline"></ion-icon>Students</li></Link>
                  ...
                  { user && <Link className='profile_' to='#'>
                      ...
                      <div className="profile-details" >
                          ...
                          <span className="btm-span">
                              <span style={{ fontFamily: 'poppins' }}>Department Supervisor</span>
